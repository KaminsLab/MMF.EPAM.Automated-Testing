...
namespace BookClass.Tests
{
    ...
    public class BookTests
    {
        ...
        [TestCase("Walter Rudin", "The Principles of Mathematical Analysis", "Advanced Mathematics")]
        [TestCase("Gilbert Strang", "Differential Equations and Linear Algebra", "  ")]
        [TestCase("", "", "")]
        ...
        [TestCase("Walter Rudin", "The Principles of Mathematical Analysis", "Advanced Mathematics", "978-0-070-85613-4")]
        [TestCase("Gilbert Strang", "Differential Equations and Linear Algebra", "  ", "   ")]
        [TestCase("Jon Skeet", "C# in Depth", "Manning Publications", "")]
